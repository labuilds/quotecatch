...
export default function MarketingPage({ params }: { params: Promise<{ vertical: string }> }) {
  ...
  const features = [
    { icon: Calculator, color: "text-orange-500", bg: "bg-orange-50", title: "AI Pricing Engine", desc: "Describe your pricing in plain English. Our AI builds the math instantly, no spreadsheets." },
    ...
    <div className="min-h-screen bg-white font-sans selection:bg-orange-200/60 overflow-x-hidden">
      ...
      <nav className="relative z-50 flex items-center justify-between px-6 py-5 max-w-7xl mx-auto border-b border-slate-100/80 bg-white/80 backdrop-blur-md sticky top-0">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-xl font-black tracking-tight text-slate-900">QuoteCatch</span>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-12">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-50 border border-orange-100 text-orange-600">
              ...
              <span className="text-[12px] font-bold tracking-wider uppercase">Built for {title} Contractors</span>
            </div>

            <h1 className="text-[3.2rem] sm:text-[4rem] lg:text-[4.8rem] font-black tracking-tighter leading-[1.03] text-slate-900">
            ...
            <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-lg">
              Embed a highly accurate, AI-powered estimating engine on your website. Capture high-intent homeowners the moment they search.
            </p>
              ...
              <div className="flex -space-x-3">
                {[
                  ...
                  <div key={i} className={`w-9 h-9 rounded-full ${c} border-2 border-white shadow-sm flex items-center justify-center`}>
                    <span className="text-[11px] font-black text-white">{['J','K','M','S'][i]}</span>
                  </div>
                ))}
              </div>
              <div>
                ...
                <p className="text-[13px] font-semibold text-slate-500 mt-0.5">Trusted by <span className="text-slate-900 font-black">500+</span> {title} contractors</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="relative z-10 w-full max-w-[420px]">
              <div className="absolute -top-4 -right-4 z-20 bg-white text-slate-900 border border-slate-200 shadow-[0_8px_24px_rgba(0,0,0,0.08)] text-[11px] font-black px-4 py-2.5 rounded-full flex gap-2 items-center animate-bounce tracking-wide uppercase">
      ...
      <section className="border-y border-slate-100 bg-slate-50 relative z-10 py-10 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6 flex flex-col items-center">
          <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em] mb-8">Trusted by contractors across the country</p>
      ...
      <section className="py-24 sm:py-32 max-w-7xl mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 border border-slate-200 text-slate-600 text-[12px] font-bold uppercase tracking-wider">
            Why contractors choose us
          </div>
          <h2 className="text-[2.8rem] md:text-[3.5rem] font-black tracking-tighter text-slate-900">The engine for conversion.</h2>
          <p className="text-xl text-slate-500 font-medium leading-relaxed">Everything you need to turn passive website traffic into high-quality, ready-to-close leads.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map(({ icon: Icon, color, bg, title: ftitle, desc }, idx) => (
            ...
            >
              ...
              <h3 className="text-[22px] font-black tracking-tight text-slate-900 mb-3">{ftitle}</h3>
              <p className="text-slate-500 text-[16px] leading-relaxed font-medium">{desc}</p>
            </motion.div>
          ))}
        </div>
        ...
        >
          <div className="flex-1 space-y-6 text-white">
            <h3 className="text-[2rem] font-black tracking-tight">One-Click Global Embed</h3>
      ...
      <section className="py-28 relative z-10 border-t border-slate-100 flex flex-col items-center justify-center text-center px-6 overflow-hidden">
        ...
        <div className="relative z-10 space-y-6 max-w-2xl">
          ...
          <h2 className="text-[3rem] md:text-[4rem] font-black text-slate-900 tracking-tighter leading-tight">Engineered to scale.</h2>
