...
const tiers = [
  ...
  },
  {
    ...
    buttonText: "Upgrade to Profit Engine",
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
      {tiers.map((tier, i) => (
        ...
        >
          ...
          {showButton && (
            <Button
              onClick={tier.highlight ? onUpgrade : undefined}
              variant={tier.buttonVariant}
              className={`w-full h-16 rounded-2xl font-black text-[16px] transition-all hover:scale-[1.02] active:scale-[0.98] ${
                tier.highlight 
