...
function SupportModal({ onClose }: { onClose: () => void }) {
  ...
  return createPortal(
    ...
    >
      ...
      {/* Modal */}
      <div
        className="relative w-full max-w-xl bg-white rounded-3xl shadow-[0_24px_80px_rgba(0,0,0,0.18)] border border-slate-100 flex flex-col overflow-hidden max-h-[calc(100vh-6rem)] md:max-h-[calc(100vh-5rem)]"
      >
        {/* Header */}
